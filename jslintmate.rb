  ...
  <style>
    ...
    body{
      ...
      background:-webkit-gradient(
        linear, left top, left bottom, from(#ececec), to(#d2d2d2));
    ...
    pre{
      ...
      padding:2px 4px;
      background:-webkit-gradient(
        linear, left top, left bottom, from(#d4d4d4), to(#e0e0e0),
        color-stop(0.1, #e0e0e0));
      background:-webkit-gradient(
        linear, left top, left bottom,
        from(rgba(0, 0, 0, 0.1)), to(rgba(0, 0, 0, 0.05)),
        color-stop(0.1, rgba(0, 0, 0, 0.05)));
    ...
    header{
      ...
      padding:0.6667em;
      background:-webkit-gradient(
        linear, left top, left bottom, from(#333), to(#090909),
        color-stop(0.5, #191919), color-stop(0.5, #090909));
    ...
    p.error{
      ...
      background:#900;
        ...
        background:-webkit-gradient(
          linear, left top, left bottom, from(#900), to(#600));
